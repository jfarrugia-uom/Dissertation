...
\begin{figure}[!ht]
    ...
    \caption{Our best \ac{MRR} and \ac{MAP} compared to Shared Task top submissions, MFH baseline.}        
...
\begin{itemize}
    ...
    \item Training CRIM on more than a single projection layer improves \ac{MAP} and \ac{MRR} performance;
\end{itemize}

The results we achieved on this dataset are competitive compared to the English, general-purpose baselines and other submissions.  
