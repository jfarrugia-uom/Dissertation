...
\begin{figure}[!ht]
    \centering
    \subbottom[Before tuning]{\includegraphics[width=0.6\textwidth]{images/ft_frozen_sum_highest_Ranked_incorrect.png} }\qquad
    \subbottom[After tuning]{\includegraphics[width=0.6\textwidth]{images/ft_transfer_max_highest_Ranked_incorrect.png} }%
